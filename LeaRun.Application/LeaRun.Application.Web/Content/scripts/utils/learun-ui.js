...
$.fn.authorizeColModel = function (gridWidth) {
    var $element = $(this);
    ...
    if (gridWidth) {
        $element.jqGrid('setGridWidth', gridWidth - 2);
    }
}
...
$.fn.selectDown = function (list) {
    var _select = '';
    _select += '<div style="width:200px;height:20px;overflow:hidden;">';
    _select += '<input type="text" id="selectButton" readonly="true" style="width:200px;height:20px;"></div>';
    _select += '<div id="fuzzysearchdiv" placeholder="搜索" style="display:none;width:200px;z-index:3;position:absolute;height:20px;">';
    _select += '<input type="text" id="fuzzysearch" style="width:185px;" /></div>';
    _select += '<div id="selectdiv" style="display:none;border:1px solid #A9A9A9;width:200px;z-index:2;position:absolute;overflow-y :scroll;height:100px;background-color:white;"><br></div>';
    $(this).html(_select);
    var initlist = list;
    //多选下拉框所在的div
    ...
    $('#fuzzysearchdiv').mouseover(function () {
        indiv = true;
    })
    ...
    $('#fuzzysearchdiv').mouseout(function () {
        indiv = false;
    })
    ...
    $('input[name=mycheckbox]').click(function () {
        ...
        if ($this.checked) {
            ...
            selectednamelist.push($this.nextSibling.nodeValue);
        } else {
